...
$UninstallText = "Dieser Uninstaller entfernt das Programm Administration und seine Komponenten."
$SuccessText = "Deinstallation erfolgreich abgeschlossen!"
$Global:Settings = "$env:LOCALAPPDATA\PowerShellTools\Administration"
$Global:Path = (Split-Path -Path $PSCommandPath -Parent) + "\Administration.ps1"
...
$Form.Text = "Uninstaller für Administration"
